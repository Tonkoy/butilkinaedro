...
export function HomeHeroBottles({ sx, ...other }) {
  ...
  const renderText = (
    <AnimatedDiv>
      ...
      >
        {`Изчистен дизайн, екологичен подход и максимален комфорт.`}
      ...
      >Удобни за офиса, спорта и пътуване – навсякъде с вас.</Typography>
