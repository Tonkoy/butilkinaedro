    ...
    >
      ...
      <Box
        ...
        sx={{
          ...
          backgroundImage: `linear-gradient(180deg, ${theme.vars.palette.background.default} 12%, ${varAlpha(theme.vars.palette.background.defaultChannel, 0.92)} 50%, ${theme.vars.palette.background.default} 88%), url('${CONFIG.assetsDir}/assets/images/home/banner_butilko.png')`,
          [stylesMode.dark]: {
            backgroundImage: `url('${CONFIG.assetsDir}/assets/images/home/banner_butilko.png'), linear-gradient(180deg, ${theme.vars.palette.background.default} 12%, ${varAlpha(theme.vars.palette.background.defaultChannel, 0.96)} 50%, ${theme.vars.palette.background.default} 88%), url('${CONFIG.assetsDir}/assets/images/home/banner_butilko.png')`,
          },
        }}
      />
    </Box>
